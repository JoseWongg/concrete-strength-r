...
Concrete Category -- binary -- Coarse/Fine -- classification based on relative proportions of fine and coarse aggregate -- Input Variable
Contains Fly Ash -- binary -- TRUE/FALSE -- indicates presence or absence of Fly Ash -- Input Variable
...
n general: A sample is a group of specimens randomly taken from a population to obtain information about a population parameter or characteristic under the assumption that the  measured or observed c  
